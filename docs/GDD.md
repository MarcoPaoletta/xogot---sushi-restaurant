...
- **The counter row.** Station labels sit on one line (Y 1.6 above the counter, 40 px Lilita instead of 56) so nothing overlaps whatever the day's mix of names is, and the two wall paintings moved up to Y 4.7 out of that line. Two warm omni lights (X ±5, Y 4.6, Z −2.4, range 11) light the back counter, which the sun left in the wall's shadow.
